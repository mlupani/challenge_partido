      ...
      <div id="teams" className='flex justify-center items-center flex-row'>
        {
          teams.length ?
            teams.map((team, i) => (
                ...
                {
                  i === 0 ?
                  <SearchList searchPlayer={searchPlayer} players={players} searching={searching} setSelectedPlayerState={setSelectedPlayerState} selectedPlayer={selectedPlayer} deleteFromTeam={deleteFromTeam} /> : null
                }
                </>
              )
            ) :
